...
CFLAGS-$(DEV_ETH_ETH)+=-DCONFIG_DEV_ETH_ETH
CFLAGS-$(DEV_ETH_ETH)+=-DCONFIG_ETH_DEFAULT_IP=\"$(ETH_DEFAULT_IP)\"
CFLAGS-$(DEV_ETH_ETH)+=-DCONFIG_ETH_DEFAULT_NM=\"$(ETH_DEFAULT_NM)\"
