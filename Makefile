...
OBJS-$(DEVUSBETH2)+=kernel/drivers/cdc_ecm.o
CFLAGS-$(DEVUSBETH2)+=-DCONFIG_DEVUSBETH2
CFLAGS-$(DEVUSBETH2)+=-DCONFIG_USB_DEFAULT_IP=\"$(USB_DEFAULT_IP)\"
CFLAGS-$(DEVUSBETH2)+=-DCONFIG_USB_DEFAULT_NM=\"$(USB_DEFAULT_NM)\"
