...
ifeq ($(ARCH_LPC17XX),y)
	...
	ARCH=LPC17XX
	MCPU=cortex-m3
	CFLAGS+=-DLPC17XX -DCONFIG_SRAM_EXTRA -D__ARM_ARCH_7M__=1
...
ifeq ($(ARCH_LM3S),y)
	...
	SYS_CLOCK=50000000
	ARCH=LM3S
	CFLAGS+=-DLM3S -D__ARM_ARCH_7M__=1
	MCPU=cortex-m3
...
ifeq ($(ARCH_STM32F4),y)
	...
	SDRAM_SIZE=0x800000
	CFLAGS+=-DSTM32F4 -mfloat-abi=soft -DCONFIG_SRAM_EXTRA -D__ARM_ARCH_7M__=1
	MCPU=cortex-m4
	ARCH=STM32F4
...
ifeq ($(ARCH_STM32F7),y)
	...
	SDRAM_SIZE=0x800000
	CFLAGS=-DSTM32F7 -mfloat-abi=soft -DCONFIG_SRAM_EXTRA -D__ARM_ARCH_7M__=1
	MCPU=cortex-m4
	ARCH=STM32F7
	OPENCM3FLAGS=FP_FLAGS="-mfloat-abi=soft"
